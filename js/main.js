...
function wordsList(str, subStr) {
  ...
  var uniqLowerCaseClearStr = str
    .replace(/[.,!?;:"]/g, '')
    .toLowerCase()
    .split(' ')
    .filter((uniqLowerCaseClearStrItem) => uniqLowerCaseClearStrItem.indexOf(subStr) > -1);
  
    let res = new Set();

    uniqLowerCaseClearStr.forEach((uniqLowerCaseClearStrItem) => {res.add(uniqLowerCaseClearStrItem);});
...
// function Day(t) {
//   var res = Math.floor(t / msPerDay);
//   return res;
// };

// console.log(Day(1548806400000));
...
console.log(getWeekDay('2019-06-02')); // 
console.log(getWeekDay('2019-06-03')); // 
console.log(getWeekDay('2019-06-04')); // 
console.log(getWeekDay('2019-06-05')); // 
console.log(getWeekDay('2019-06-06')); // 
console.log(getWeekDay('2019-06-07')); // 
console.log(getWeekDay('2019-06-08')); // 

console.log(getWeekDay('2019-08-04')); // 
console.log(getWeekDay('2019-08-05')); // 
console.log(getWeekDay('2019-08-06')); // 
console.log(getWeekDay('2019-08-07')); // 
console.log(getWeekDay('2019-08-08')); // 
console.log(getWeekDay('2019-08-09')); // 
console.log(getWeekDay('2019-08-10')); // 
...
function getDateAgo(date, days) {
  ...
  return res.toLocaleDateString('ru-EU').replace(/[/]/g, '.');
}
...
var testPerformance = function(iterations, func) {
